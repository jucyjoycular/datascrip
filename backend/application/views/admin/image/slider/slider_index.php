   ...
   <section class="section">
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                  <h5 class="card-title">Slider Banner</h5>
                  <div style="margin-bottom: 10px;">
<a href="<?php echo site_url('admin/insert_slider');?>" class='btn btn-primary'>
   Insert Data
</a>
</div><br>
                           ...
                           <tbody>
                              <?php 
														...
														foreach($slider as $data)
														{
															...
															$foto = $data->filename;
															$datarlimg = base_url("assets/upload/slider/$foto");
														...
														<tr bgcolor="#fff">
															...
															<td>
																<a href="<?php echo base_url();?>admin/slider_edit/<?php echo $data->id_banner?>" class="btn btn-warning">Edit</a> <a href="<?php echo base_url();?>admin/delete_slider/<?php echo $data->id_banner?>" onclick="return confirm('Do you want delete this data?')" class='btn btn-danger'>
                                                  Delete
                                                </a>
															</td>
